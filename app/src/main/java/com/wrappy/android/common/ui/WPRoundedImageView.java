...
/**
 * Duplicate of RoundedImageView from ChatKit library
 * with draw() fix
 */
public class WPRoundedImageView extends AppCompatImageView {
    ...
    public WPRoundedImageView(Context context) {
        super(context);
    }

    public WPRoundedImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public WPRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
